...
%-----------TECHNICAL SKILLS-----------
    ...
    \begin{itemize}[leftmargin=0em, label={}]
        \small{\item{
            ...
            \textbf{Developer Tools}{: Docker, Git, Google Cloud Platform, Firebase, Address Sanitizer, General Unix CLIs} \\
        }}
    \end{itemize}
...
%-----------EXPERIENCE-----------
    ...
    {\href{https://www.uoguelph.ca/computing}{Department of Computer Science}}{Guelph, ON}
    \begin{center}
        \textit{Investigation of the effectiveness of UI designs in the presence of situational vision impairments (SVIs), and human perception of contrast and color}
    \end{center}
    ...
    \begin{ResumeItem}
        ...
        \item{Implemented transparent WebGPU usage metrics tracking system, opening up the ability to utilize web browsers for GPGPU such as AI inferencing}

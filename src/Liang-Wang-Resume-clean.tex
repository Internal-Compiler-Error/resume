...
\begin{ResumeItem}
    % \item{Developed and integrated a feature for the flagship product to ingest and analyze Discord data produced in response to warrants}
...
\begin{ResumeItem}
    ...
    \item{Integrated existing APIs into a React Native application with the minimum viable environment above}
